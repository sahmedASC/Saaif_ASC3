...
residence = ["California","The Abyss","NY","NJ","Weeb City","Abreuboom's House", "a GitHub repository","an infinite loop","a syntax error","an index.html file","a program with an error you can never solve"]
